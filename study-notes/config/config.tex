...
\newcommand*{\spn}[1]{\operatorname{span}\qty(#1)}
\newcommand*{\col}[1]{\operatorname{col}(#1)}
\newcommand*{\row}[1]{\operatorname{row}(#1)}
\newcommand*{\rk}[1]{\operatorname{rank}(#1)}
\newcommand*{\nul}[1]{\operatorname{null}(#1)}
\newcommand*{\nulty}[1]{\operatorname{nullity}(#1)}
...
\newenvironment{draft}{\sffamily\textcolor{cyan}{\lbrack Draft \faIcon{edit}:}}
{\!\!\textcolor{cyan}{\rbrack}\begin{center}{\textbf{\underline{Actual work}}}\end{center}}
