...
\begin{itemize}
\item \defn{type I}: interchanging two different rows
\item \defn{type II}: multiply a row by a \emph{nonzero} scalar
\item \defn{type III}: adding a scalar multiple of a row to another row
\end{itemize}
