...
every zero row (if exists) still remains as a zero row. The leading ones still
satisfy with the requirements imposed by RREF as they are not affected by the
removal.
...
\end{note}
\end{enumerate}
\subsection{Number of Solutions for Systems of Linear Equations}
